#! aplikasi data siswa sederhana menggunakan method
#! created by ramon mister hadi | 312010508 | fti-uksw
import os
import sys
...
def menu():
	os.system('cls')
	print("Menu Aplikasi Data Siswa dengan penggunaan")
	print("-------------------------------------------")
...
def author():
	os.system('cls')
	print("Ramon mister hadi | 312010508")
	print("pelita bangsa")
...
def pilih1():
	...
	while ulang in('y', 'Y'):
		...
		ulang = input("Apakah Anda Ingin Menambahkan1 (Y/ T)? ")		
